...
//LCD_RS//dc  
#define LCD_RS_SET      1//HAL_GPIO_WritePin(LCD_WR_RS_GPIO_Port,LCD_WR_RS_Pin,GPIO_PIN_SET)//PC4
#define LCD_RS_RESET    1//HAL_GPIO_WritePin(LCD_WR_RS_GPIO_Port,LCD_WR_RS_Pin,GPIO_PIN_RESET)
//LCD_CS  
#define LCD_CS_SET      HAL_GPIO_WritePin(SPI4_CS_GPIO_Port,SPI4_CS_Pin,GPIO_PIN_SET)
#define LCD_CS_RESET    HAL_GPIO_WritePin(SPI4_CS_GPIO_Port,SPI4_CS_Pin,GPIO_PIN_RESET)
//SPI Driver
#define SPI spi4
...
void LCD_ShowLineString(uint8_t Line, uint8_t* string){
	LCD_ShowString(4, Line, ST7735Ctx.Width, 16, 16, string);
};
